...
import numpy as np
import utilities
from demo.flood_fill_demonstration.transformer import Transformer
...
class FloodFillPlaygroundDetector:
    def __init__(self, petanque_detection):
        ...
        with open("demonstration_playground_state.json", "w") as f:
            f.write('{"playground_transformations": [{"lab_l": -0.1066981862411455, "hsv_v": 0.4332014922100218, "bgr_b": -0.5655189680535998, "lab_a": 0.128281968569768, "hsv_s": -0.04565437890618004, "ycrcb_cn": -0.0673199079849727, "ycrcb_cr": 0.3999143623408969, "lab_b": -2.042899983569279, "bgr_g": 0.4834651120200578, "ycrcb_y": 0.02385616657809432, "bgr_r": -0.21047363028663796}], "ball_transformations": null}')
        self.transformer = Transformer(filename="demonstration_playground_state.json")
...
if __name__ == "__main__":
    ...
    import os
    filenames = []
    for cur in os.walk(os.path.join(utilities.get_project_directory(), "demo/flood_fill_demonstration/")):
        filenames = cur[2]
        break
    ...
    try:
        ...
        flood_fill.transformer.save(filename="demonstration_playground_state.json")
